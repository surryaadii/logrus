...
func OptKeyClock() string {
	return optkeyClock
}

func OptKeyLinkName() string {
	return optkeyLinkName
}

func OptKeyMaxAge() string {
	return optkeyMaxAge
}

func OptKeyRotationTime() string {
	return optkeyRotationTime
}

func OptKeyRotationCount() string {
	return optkeyRotationCount
}
